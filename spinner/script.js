    ...
    Wilq32.PhotoEffect.prototype = {
        _setupParameters: function (parameters) {
            ...
            if (typeof this._parameters.center[0] == "string") {
                this._rotationCenterX = (parseInt(this._parameters.center[0], 5) / 100) * this._imgWidth * this._aspectW;
            } else {
                this._rotationCenterX = this._parameters.center[0];
            }
            if (typeof this._parameters.center[1] == "string") {
                this._rotationCenterY = (parseInt(this._parameters.center[1], 5) / 100) * this._imgHeight * this._aspectH;
            } else {
...
$(".btn").click(function () {
    var xyz = [360, 286, 215, 140, 75];

// Generate a random index between 0 and the length of the array minus 1
    var randomIndex = Math.floor(Math.random() * xyz.length);

// Use the random index to access the value in the array and store it in a variable
    var randomValue = xyz[randomIndex];

    console.log("Random value: " + randomValue);

    var spin = xyz[randomIndex];
    $(".wheel").rotate({
        angle: 0,
        animateTo: 720 + spin,
        duration: 6000
    ...
    setTimeout(function () {
        $(".wheel").stopRotate();
        let image = document.getElementById('gift_image');
        const apiUrl = `fetch_image.php?spin=${spin}`;
        fetch(apiUrl)
